...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("ring-border bg-card text-card-foreground gap-6 overflow-hidden rounded-lg py-6 text-sm ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 [&>img:first-child]:rounded-t-lg [&>img:last-child]:rounded-b-lg group/card flex flex-col", className)}
      {...props}
    />
  )
}
